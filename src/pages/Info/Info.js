        ...
        <div className='about-me'>
          ...
          <div className='text-container'>
            <p>
              ...
              computadora. Mi nombre es Adriana Lago, y mi viaje en el mundo de
              la fotografía y la edición de video ha sido una emocionante
              búsqueda de la belleza y la creatividad en todos los rincones de
              la vida.
            </p>
            <p>
              ...
              desarrollar un ojo crítico para la composición, la luz y la
              emoción que puede capturarse en un solo instante. Mis proyectos
              personales, que abarcan desde retratos emocionales hasta paisajes
              evocadores, reflejan mi profundo interés por la diversidad y la
              singularidad de la experiencia humana.
            </p>
            <p>
              La edición de video, por otro lado, me ha proporcionado una
              herramienta adicional para contar historias de manera más
              dinámica. He tenido la oportunidad de trabajar en proyectos que
              van desde documentales cortos hasta videoclips musicales, y cada
              uno de ellos ha sido una oportunidad para experimentar con
              diferentes estilos visuales y técnicas de edición. La
              postproducción se ha convertido en mi lienzo digital, donde puedo
            ...
            {/* <p>
              ...
              Cada proyecto es una oportunidad para aprender y crecer, y estoy
            ...
            <p>
              ...
              compromiso que dedico a mi oficio. Si estás interesado en
              colaborar o simplemente quieres hablar sobre proyectos creativos,
              ¡estaré encantada de conocerte! La fotografía y la edición de
